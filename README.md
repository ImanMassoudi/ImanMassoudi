...
<a href="https://www.linkedin.com/in/muqtadir-massoudi-a29195226/" target="_blank" class="share-link btn btn-primary btn-md-square rounded-circle mb-2" style="background: #003366; margin-left: 0.5rem; color: black; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.596);"><i class="fab fa-linkedin-in" style="color: white;"></</a>
